...
Pull requests run checks and a Docker image smoke test. Publishing to Docker Hub is restricted to pushes on `main`, version tags, and explicitly selected manual publishing runs. The image currently targets `linux/amd64`.
